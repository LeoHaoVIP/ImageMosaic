...
+ The [output](./output) directory contains panorama results generated by [ImageMosaic.py](./ImageMosaic.py). Images in the [unblend](./unblend) directory are the mosaic results without seam elimination.
